...
Speech-to-Text (STT) technology has rapidly evolved in recent years, driven by advancements in deep learning algorithms such as recurrent neural networks (RNNs) and convolutional neural networks (CNNs), which have significantly improved the accuracy of STT systems \cite{Televic:2024}. These systems, which convert speech into text, have become an essential component of various applications, from virtual assistants to transcription services \shortcite{Cerna:2023}. However, despite these advancements, only a few Philippine languages have been explored and integrated into this technology. This special problem focuses on one of the understudied Central Philippine languages, Akeanon. 
...
The general objective of this study is to construct and establish a comprehensive text and speech corpus for the Akeanon language, which can serve as a foundation for future development of language technologies and automatic speech recognition (ASR) systems.
...
\begin{enumerate}
    \item Collect and compile existing Akeanon language resources, including dictionary-based word lists, phonetic transcriptions, and audio transcriptions from online sources.
    \item Develop a text corpus by organizing and annotating Akeanon words and phrases with their phonetic transcriptions.
    \item Build a speech corpus by recording native Akeanon speakers, ensuring diversity in gender and age.
    \item Preprocess the recorded speech data through normalization and noise reduction for optimal quality.
